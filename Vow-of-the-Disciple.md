...
_Brought to you by bigred76, cpTylor, and Tr1d3nT_
...
The Challenge for this encounter is fairly straightforward: each Runner can only dunk ONE buff from inside at a time.

You can do this multiple ways, the one that we found that worked for us was to have three Runners, one Add Clear, and two Distractors. The Runners would cycle into the room, grab their one buff and run out, wait for their name to appear in the debuff list and shoot their symbol. The Add Clear had a lot of ground to cover but it was doable. Void volatility worked well, Risk Runner works well, Dunemarchers work well, Contraverse Hold/Nezarick's Sin works well. You do not need as much weapon damage as Contest Mode for the Caretaker himself so your Add Clear can even consider options like heavy MG's like Commemoration that would take advantage of the Void Volatility. Your add clear will know what works best for them. The key to success for us was that if at any point the adds started to overwhelm the Add Clear they would call it out. All of the available Runners would turn and shoot. It is very quick this way to get back on top of add control, do not be afraid to ask for a second of help!
